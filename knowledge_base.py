...
建議加 LINE 讓我們幫您抓最適合的方案 👍
👉 LINE@：@JSIMPLE""",
    "custom": """可以訂製唷！KY 系列全系列支援客製 🎉

✅ 可調整：床體長寬、離地高度、梯子方向、護欄高度
建議傳房間尺寸或照片給我們評估！
👉 LINE@：@JSIMPLE""",
    "shipping": """運費與安裝費說明：

🚚 北部：NT$1,000 / 中南部：NT$1,300
🔧 無電梯每層加 NT$300 / 有電梯 NT$300
...
✅ 信用卡、ATM 轉帳、LINE Pay、貨到付款（限特定區域）
暫不提供分期服務""",
    "return": """退換貨說明 📋
