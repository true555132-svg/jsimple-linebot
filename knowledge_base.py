...
LINE_REPLIES  = dict(_BASE_REPLIES)
FB_REPLIES    = dict(_BASE_REPLIES)
LINE_KEYWORDS = {k: list(v) for k, v in _BASE_KEYWORDS.items()}
FB_KEYWORDS   = {k: list(v) for k, v in _BASE_KEYWORDS.items()}
